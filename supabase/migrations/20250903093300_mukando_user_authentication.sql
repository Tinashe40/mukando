...
BEGIN
    ...
    INSERT INTO auth.users (
        ...
        (sarah_uuid, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated',
         'sarah@mukando.com', crypt('member123', gen_salt('bf', 10)), now(), now(), now(),
         '{"full_name": "Sarah Mukamuri", "phone_number": "+263772345678", "country": "ZW", "mobile_money_provider": "ecocash", "role": "member"}'::jsonb, 
         '{"provider": "email", "providers": ["email"]}'::jsonb,
         false, false, '', null, '', null, '', '', null, '', 0, '', null, null, '', '', null),
